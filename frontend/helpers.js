 ...
 * ÄNDERUNG 13.08.2025: HTML-Rendering-Fix - SKIP sanitization for search results
 */
function safeSetHTML(element, html) {
    ...
    // CRITICAL FIX: Skip sanitization for search results display
    // The HTML generated by generateModernResultCard() is safe and should be rendered
    const isResultsElement = element.id === 'results' || element.classList.contains('results-container');
    
    if (!isResultsElement && typeof sanitizeHTML === 'function') {
        // Only sanitize non-results content for security
