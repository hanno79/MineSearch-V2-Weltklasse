                ...
                async () => {
                    ...
                    try {
                        ...
                        results.functionsAvailable = {
                            calculateAdvancedPerformanceScore: typeof window.calculateAdvancedPerformanceScore !== 'undefined',
                            calculateConfidenceWeightedConsistency: typeof window.calculateConfidenceWeightedConsistency !== 'undefined',
