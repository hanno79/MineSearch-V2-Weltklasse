        ...
        try:
            ...
            if result.get('success'):
                ...
                if raw_response:
                    ...
                    mining_terms = ['mine', 'mining', 'exploration', 'gold', 'copper', 'quebec',
'lac expanse', 'operator', 'owner', 'production']
    ...
    async def main():
        ...
        if result.get('success'):
            if result['raw_response_empty']:
                ...
                print(f"   ➤ Problem is in API response, not data_dict extraction")
                if comparison_ok:
                ...
                print(f"   ➤ Problem is in data_dict extraction patterns")
        else:
