...
async def test_statistics_tab_comprehensive():
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            statistics_tab = page.locator('a[href="#statistiken"], a[data-target="statistiken"],
.nav-link:has-text("Statistiken")')
            ...
            try:
                ...
                await page.wait_for_selector('[data-tab="statistiken"], .statistics-content,
#statistiken', timeout=10000)
            ...
            try:
                ...
                if isinstance(models_response, dict) and 'error' not in models_response:
                    print(f"✅ API Response erhalten: {len(models_response) if
isinstance(models_response, list) else 'Object'}")
                else:
