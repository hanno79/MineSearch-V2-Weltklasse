...
class APIResponseDebugger:
    ...
    async def test_perplexity_response(self):
        ...
        print("🔍 PERPLEXITY API RESPONSE DEBUG")
        print("=" * 60)
        ...
        try:
            ...
            if result.get('success'):
                ...
                mining_terms = ['mine', 'mining', 'gold', 'copper', 'exploration', 'production', 'operator', 'owner', 'restoration', 'cost']
...
if __name__ == "__main__":
    async def main():
        ...
        print(f"\n💾 Detailed results saved to api_response_debug_results.json")
