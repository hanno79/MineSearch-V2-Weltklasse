...
async def test_statistics_button_click():
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            providers = ['perplexity', 'openai', 'anthropic', 'gemini', 'grok', 'openrouter', 'tavily', 'brightdata', 'firecrawl']
            found_providers = []
            ...
            await page.evaluate("console.log('Testing console'); if (window.loadModelStatistics) loadModelStatistics();")
            await page.wait_for_timeout(2000)
