...
"RESEARCH RESULT: No verified mining operation found with name '{mine_name}' in {region}, {country}. This may be a non-existent mine, misnamed location, or very small operation not in standard databases."
"""
