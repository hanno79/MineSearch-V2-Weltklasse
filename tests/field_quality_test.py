        ...
        try:
            ...
            for result in test_result:
                ...
                if result['qualityBreakdown']:
                    ...
                    print(f"   Breakdown: 🟢{breakdown['high']} hoch, 🟡{breakdown['medium']} mittel, 🔴{breakdown['low']} niedrig, ⚫{breakdown['empty']} leer")
            ...
            if len(scores) >= 3:
                ...
                print(f"\\n✅ Quality progression: {quality_progression} ({high_score:.1f} > {medium_score:.1f} > {low_score:.1f})")
            ...
            breakdown_result = await page.evaluate("""
                () => {
                    ...
                    if (typeof generateScoreBreakdown !== 'undefined') {
                        ...
                        const hasQualityBreakdown = breakdownHtml.includes('🟢') && breakdownHtml.includes('🟡') && breakdownHtml.includes('🔴');
