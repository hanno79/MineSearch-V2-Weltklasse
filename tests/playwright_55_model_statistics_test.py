...
class MineSearchE2ETester:
    ...
    async def verify_55_model_statistics_cards(self):
        ...
        logger.info(f"📊 [E2E-VERIFICATION] Found {self.post_search_model_count} model cards
(initial: {self.initial_model_count})")
        ...
        # Assertions
        assert self.post_search_model_count >= 45, f"Expected at least 45 model cards, got
{self.post_search_model_count}"
...
async def test_55_model_statistics_update_pipeline():
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            logger.info(f"📊 [E2E-SUMMARY] Models selected: {selected_count}, Initial cards:
{tester.initial_model_count}, Final cards: {tester.post_search_model_count}")
