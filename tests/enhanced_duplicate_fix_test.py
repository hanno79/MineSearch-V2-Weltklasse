        ...
        try:
            ...
            consolidation_analysis = await page.evaluate("""
                () => {
                    ...
                    console.log(`📊 [ENHANCED-ANALYSIS] ${modelCards.length} cards,
${Object.keys(modelCounts).length} unique, ${duplicates.length} duplicates`);
            ...
            if consolidation_analysis['enhancedSuccess']:
                ...
                if duplicates_count > 0:
                    ...
                    for dup in consolidation_analysis['duplicates']:
                        print(f"   - {dup['normalizedName']}: Analysiere Unterschiede zwischen
{dup['count']} Instanzen")
