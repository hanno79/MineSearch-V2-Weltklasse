            ...
            try:
                ...
                if table_analysis['exact_duplicates'] > 0:
                    ...
                    if not duplicated_rows.empty:
                        ...
                        sample_columns = [col for col in ['id', 'name', 'company_name', 'mine_name',
'url'] if col in df.columns][:3]
                ...
                for col in key_columns:
                    if col in df.columns and not df[col].isna().all():
                        ...
                        if len(col_duplicates) > 0:
                            ...
                            print(f"   ⚠️  {col.upper()}-DUPLIKATE: {len(col_duplicates)}
verschiedene Werte, {col_duplicates.sum()} Einträge betroffen")
