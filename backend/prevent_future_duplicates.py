...
class PermanentDuplicatePrevention:
    ...
    def _migrate_mines_table(self, conn: sqlite3.Connection) -> bool:
        ...
        try:
            ...
            print("      📦 Migriere Daten zur neuen Tabelle...")
            cursor.execute("""
                INSERT INTO mines_new (id, name, country, state_province, latitude, longitude, normalized_name, created_at, updated_at)
            ...
            if similar_companies:
                if auto_merge:
                    ...
                    return {
                        ...
                        'action': 'auto_merged',
                        'message': f'Auto-Merge mit "{best_match["name"]}" (Ähnlichkeit: {best_match["similarity"]:.2%})',
