...
def radical_database_cleanup():
    ...
    try:
        ...
        cursor.execute("DELETE FROM sqlite_sequence WHERE name IN ('mine_data_fields', 'search_sessions', 'mines', 'companies')")
        ...
        performance_indexes = [
            ...
            ("idx_mine_data_fields_normalized", "mine_data_fields(commodity_id, company_id, activity_status_id, mine_type_id, country_id, region_id)"),
