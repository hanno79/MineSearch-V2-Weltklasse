...
def cleanup_test_entries():
    ...
    try:
        ...
        for field_id, field_name in test_fields:
            ...
            logger.info(f"✅ TEST Feld '{field_name}' (ID {field_id}) gelöscht - {data_count}
mine_data_fields + {values_count} field_values entfernt")
        ...
        logger.info(f"Verbliebene Test-Einträge: Mines={test_mines}, Countries={test_countries},
Fields={test_fields_remaining}")
