...
at|position)\s+(?:etwa\s+)?[-+]?\d+\.?\d+\s*°?\s*[NS]\s*[,/]\s*([-+]?\d+\.?\d+)\s*°?\s*[EW]',
        ...
        'Produktionsende': [
            ...
            r'Produktionsende:\s*(\d{4}\s*\([^)]*(?:reopened|resumed|wieder|neustart)[^)]*\))',  #
"2013 (reopened in 2021)"
            ...
            r'((?:closed|geschlossen)\s+\d{4}[,;\s]*(?:reopened|resumed|wieder)\s+\d{4})',  #
"closed 2013, reopened 2021"
