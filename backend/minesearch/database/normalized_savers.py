        ...
        for field_name, field_value in structured_data.items():
            ...
            if field_type == 'normalized':
                ...
                # Minentyp-Normalisierung
                    ...
                    mine_type_id = manager_self.get_or_create_mine_type(atomic_value, smart_extractor=manager_self.smart_extractor, db_session=session)
                ...
                # Region-Normalisierung
                    ...
                    region_id = manager_self.get_or_create_region(atomic_value, smart_extractor=manager_self.smart_extractor, country_id=country_for_region, db_session=session)
...
def save_search_result_normalized(
    ...
    try:
        ...
        mine_id = manager_self.get_or_create_mine(mine_name, smart_extractor=manager_self.smart_extractor, structured_data=structured_data, db_session=db_session)
        ...
        if db_session is not None:
            ...
            save_mine_field_data(manager_self, mine_id, search_result_id, structured_data, model_used, sources, session_id=session_id, db_session=session)
            session.commit()
        else:
            with manager_self.get_session() as session_local:
                ...
                # 4. Speichere atomare Feldwerte
                save_mine_field_data(manager_self, mine_id, search_result_id, structured_data, model_used, sources, session_id=session_id)
