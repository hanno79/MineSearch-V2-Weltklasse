...
class NormalizedDatabaseManager(DatabaseManager):
    ...
    def get_or_create_company(self, company_name: str, smart_extractor=None, db_session: Optional[Session] = None, db_manager=None) -> Optional[int]:
        ...
        return get_or_create_company(company_name, smart_extractor or self.smart_extractor, db_session, db_manager or self)
    ...
    def get_or_create_region(self, region_name: str, smart_extractor=None, country_id: Optional[int] = None, db_session: Optional[Session] = None, db_manager=None) -> Optional[int]:
        """Delegiert an normalized_getters.py"""
        return get_or_create_region(region_name, smart_extractor or self.smart_extractor, country_id, db_session, db_manager or self)
    ...
    def get_or_create_mine_type(self, type_name: str, smart_extractor=None, db_session: Optional[Session] = None, db_manager=None) -> Optional[int]:
        """Delegiert an normalized_getters.py"""
        return get_or_create_mine_type(type_name, smart_extractor or self.smart_extractor, db_session, db_manager or self)
    
    def get_or_create_commodity(self, commodity_name: str, smart_extractor=None, db_session: Optional[Session] = None, db_manager=None) -> Optional[int]:
        """Delegiert an normalized_getters.py"""
        return get_or_create_commodity(commodity_name, smart_extractor or self.smart_extractor, db_session, db_manager or self)
    ...
    def get_or_create_activity_status(self, status_name: str, smart_extractor=None, db_session: Optional[Session] = None, db_manager=None) -> Optional[int]:
        """Delegiert an normalized_getters.py"""
        return get_or_create_activity_status(status_name, smart_extractor or self.smart_extractor, db_session, db_manager or self)
    ...
    def get_or_create_mine(self, mine_name: str, smart_extractor=None, structured_data: Dict[str, Any] = None, db_session: Optional[Session] = None, db_manager=None) -> Optional[int]:
        """Delegiert an normalized_getters.py"""
        return get_or_create_mine(mine_name, smart_extractor or self.smart_extractor, structured_data, db_session, db_manager or self)
    ...
    def save_mine_field_data(self, mine_id: int, search_result_id: int, structured_data: Dict[str, Any], 
        ...
        return save_mine_field_data(self, mine_id, search_result_id, structured_data, model_used, sources, session_id, db_session, value_normalizer)
    ...
    def save_search_result_normalized(self, mine_name: str, structured_data: Dict[str, Any], 
        ...
        """Delegiert an normalized_savers.py"""
        return save_search_result_normalized(self, mine_name, structured_data, sources, model_used, search_duration, session_id, db_session, value_normalizer)
