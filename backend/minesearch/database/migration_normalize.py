...
class DatabaseNormalizer:
    ...
    def analyze_existing_data(self):
        ...
        try:
            ...
            cursor.execute("""
                SELECT id, mine_name, country, structured_data, structured_data_with_sources,
model_used, search_timestamp
                FROM search_results
                ORDER BY id
            """)
            ...
            for row in results:
                search_id, mine_name, country, structured_data, structured_data_with_sources,
model_used, timestamp = row
