...
class NormalizedDatabaseMigration:
        ...
        try:
            with self.SessionLocal() as session:
                ...
                ai_models_data = [
                    ...
                    {'provider': 'openrouter', 'model_name': 'claude-3.5-sonnet', 'full_model_id': 'openrouter:claude-3.5-sonnet'},
                    {'provider': 'openrouter', 'model_name': 'gpt-4o', 'full_model_id': 'openrouter:gpt-4o'},
                    {'provider': 'openrouter', 'model_name': 'gemini-2.0-flash-exp', 'full_model_id': 'openrouter:gemini-2.0-flash-exp'},
                    {'provider': 'openrouter', 'model_name': 'perplexity-sonar-pro', 'full_model_id': 'openrouter:perplexity-sonar-pro'},
    ...
    def run_complete_migration(self) -> bool:
        ...
        logger.info(f"📊 Zusammenfassung: {summary['total_tables']} Tabellen, {summary['lookup_tables_populated']} mit Daten")
