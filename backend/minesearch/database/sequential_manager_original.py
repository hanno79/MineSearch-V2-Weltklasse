...
class SequentialDatabaseManager:
    ...
    """create_discovery_session - TODO: Dokumentation hinzufügen"""
        self,
        mine_name: str,
    ...
    """update_discovery_progress - TODO: Dokumentation hinzufügen"""
        self,
        session_id: str,
    ...
    """_log_source_contribution - TODO: Dokumentation hinzufügen"""
        self,
        session_id: str,
        model_id: str,
        source_id: int,
    ...
    """get_accumulated_sources - TODO: Dokumentation hinzufügen"""
        self,
        session_id: str,
        country: Optional[str] = None,
        region: Optional[str] = None,
        ...
        logger.info(f"[SequentialDatabaseManager] Retrieved {len(sources)} accumulated sources for
session: {session_id}")

        return sources

    def get_all_accumulated_sources(
    """get_all_accumulated_sources - TODO: Dokumentation hinzufügen"""
        self,
        country: Optional[str] = None,
        region: Optional[str] = None,
    ...
    """log_field_search_result - TODO: Dokumentation hinzufügen"""
        self,
        session_id: str,
        model_id: str,
        field_name: str,
    ...
    """create_sequential_result - TODO: Dokumentation hinzufügen"""
        self,
        session_id: str,
        mine_name: str,
        ...
        logger.info(f"[SequentialDatabaseManager] Sequential result created: {session_id} with
quality score: {result.overall_quality_score}")
    ...
    def get_model_effectiveness_stats(self, model_id: str, limit_days: int = 30) -> Dict[str, Any]:
        ...
        return {
            ...
            'source_discovery_effectiveness': (unique_sources / total_contributions * 100) if
total_contributions > 0 else 0,
            'successful_field_searches': successful_field_searches,
            'total_field_searches': total_field_searches,
            'field_search_success_rate': (successful_field_searches / total_field_searches * 100) if
total_field_searches > 0 else 0,
