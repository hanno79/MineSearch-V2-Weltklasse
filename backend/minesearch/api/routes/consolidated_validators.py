...
Datum: 11.09.2025
Version: 1.0
Beschreibung: Validierungs- und Qualitätsbewertungs-Logic für konsolidierte Ergebnis-Verarbeitung (Refactoring aus consolidated_results.py)
"""
...
def create_structured_fields_response(detailed_breakdown: Dict, best_values: Dict, mine_data: Dict, global_source_index: Dict) -> Dict:
    """
