...
def _apply_defaults_to_models(models_dict, provider_category_default=None, default_supports_web_search=False):
    """_apply_defaults_to_models - TODO: Dokumentation hinzufügen"""
...
OPENROUTER_MODELS = {
    ...
    # ENTFERNT 15.01.2025: Gemini-Modelle verschoben zu separaten Google-Provider
...
__all__ = [
    ...
    'SCRAPINGBEE_MODELS', 'FIRECRAWL_MODELS', 'BRIGHTDATA_MODELS',
    'OPENAI_MODELS', 'ANTHROPIC_MODELS', 'GEMINI_MODELS', 'GROK_MODELS',
