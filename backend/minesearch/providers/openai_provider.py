...
class OpenAIProvider(AbstractProvider):
        ...
        for model_key, model_data in models.items():
            if isinstance(model_data, dict):
                model_configs[model_key] = ModelConfig(
                    ...
                    provider='openai',  # Korrekte Provider-Zuordnung
                    ...
                    provider_category=model_data.get('provider_category', 'openai')
                )
    ...
    def get_system_prompt(self) -> str:
        """Abstrakte Methode: System-Prompt für OpenAI"""
        return "You are a professional mining data analysis assistant using OpenAI models."
