...
"""
        ...
        if sources:
            ...
            other_sources = [s for s in sources if s.get('type') not in ['government', 'database',
'document', 'exchange']]
...
- x-Koordinate: [GPS Latitude aus Survey-Data mit Referenz oder leer]
...
- Fördermenge/Jahr Rohstoff: [Spezifische Rohstoffproduktion aus Production Statistics, z.B.
'120,000 Unzen Gold' oder leer]
