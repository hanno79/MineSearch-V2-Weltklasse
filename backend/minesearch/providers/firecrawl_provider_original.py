            ...
            try:
                if model_id == 'scrape':
                    ...
                    async with aiohttp.ClientSession() as crawl_session:
                        crawl_results = await self._crawl_website(crawl_session, url, {'mine_name':
options.get("mine_name", '')})
                        if crawl_results:
                            ...
                            result = {
                                ...
                                'title': crawl_results[0].get('title', 'Crawled Data') if
crawl_results else 'Mining Data',
...
region=None, commodity=commodity)
    ...
    async def crawl_sources(self, discovered_sources: List[Dict], model_id: str, options: Dict[str,
Any]) -> Dict[str, Any]:
        """
...
Analysiere die folgenden Firecrawl Markdown-Crawling Ergebnisse und extrahiere strukturierte
...
"""
            ...
            user_prompt = f"""Analysiere die Firecrawl Markdown-Crawling-Ergebnisse und extrahiere
